...
#print(SLPe)
#print(SLPg)
#timeValues = ["00:00","00:15","00:30","00:45","01:00","01:15","01:30","01:45","02:00"]
#SLPe = [0.1 ,0.1,0.1,0.13333,0.13333,0.13333,0.1,0.1,0.1]
#SLPg = [0.05,0.1,0.15,0.15,0.1,0.15,0.15,0.1,0.05]
...
#for i,j in huidigProfielRV.get("CO2").items():
#    for k,l in huidigProfielSWW.get("CO2").items():
#        for m,n in huidigProfielElec.get('CO2').items():
#            if i == k == m:
#                huidigProfiel['CO2'] = j+l+n
